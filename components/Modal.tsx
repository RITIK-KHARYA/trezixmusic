  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed drop-shadow-md border border-neutral-700 top-[50%] left-[50%] h-full max-h-full md:h-auto md:max-w-[450px] translate-x-[-50%] w-full translate-y-[-50%] md:max-h-auto rounded-md bg-neutral-800 p-[25px] focus:outline-none">
